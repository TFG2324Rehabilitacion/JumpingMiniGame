...
public class OldRealmController : MonoBehaviour
{
    private static OldRealmController _instance;
    public static OldRealmController Instance { get { return _instance; } }
    ...
    private PlayerData GetPlayerData(string id)
    {
        ...
        PlayerData playerData = _realm.All<PlayerData>().FirstOrDefault(data => data.PlayerId == id && data.Name == "tobillo - jumpgame");
